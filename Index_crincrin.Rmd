...
The decision modeling team included 13 *(academics, nutritionists, plant breeder, research institutions)*.  
...
normalized_matrix_crincrin_all <- normalize_intervention_data(
...
normalized_matrix_crincrin_men_boukoumbe <- normalize_intervention_data(
...
normalized_matrix_crincrin_men_natitingou <- normalize_intervention_data(
...
normalized_matrix_crincrin_women_boukoumbe <- normalize_intervention_data(
...
normalized_matrix_crincrin_women_natitingou <- normalize_intervention_data(
