...
unified_matrix = normalized_matrix_fonio_women_natitingou
...
ggplot(results, aes(x = feasibility, y = impact, size = total_score)) +
  ...
  # # Use later for the graphical abstract
